...
#include "ns3/ndnSIM/NFD/daemon/table/cs-policy-popularity-priority.hpp"
  ...
  , m_isMAGICEnabled(false)
{
  ...
  m_csPolicies.insert({"nfd::cs::popularity_priority_queue", [] () { return make_unique<nfd::cs::PopularityPriorityPolicy>(); }});
...
void
StackHelper::setMAGICEnabled(bool enabled){
  m_isMAGICEnabled = enabled;
}
